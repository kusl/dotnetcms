#!/bin/bash
# Fix: Add ordered list support to MarkdownService
# The current implementation only handles unordered lists (- or *)
# This adds support for ordered lists (1. 2. 3. etc.)

cat << 'EOF' > src/MyBlog.Core/Services/MarkdownService.cs
using System.Text;
...
echo "Fixed MarkdownService.cs - added ordered list support"
echo ""
echo "Changes made:"
echo "  1. Added OrderedListPattern regex: ^\d+\.\s+(.+)$"
echo "  2. Added ListType enum to track current list type"
echo "  3. Ordered lists now render as <ol><li>...</li></ol>"
echo "  4. Markdown like '1. item' now auto-numbers correctly"
echo ""
echo "Rebuild and redeploy:"
echo "  dotnet build src/MyBlog.slnx"
echo "  dotnet publish src/MyBlog.Web -c Release ..."
