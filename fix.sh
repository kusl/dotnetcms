#!/bin/bash
# Fix: Make MarkdownServiceTests cross-platform by not depending on specific newline characters

cat << 'EOF' > src/MyBlog.Tests/Unit/MarkdownServiceTests.cs
...
echo "Fixed MarkdownServiceTests.cs - added NormalizeNewlines helper for cross-platform compatibility"
